...
public class AccessoriesCategoriesViewHolder extends RecyclerView.ViewHolder {

    private TextView Title;
    public ImageView Image;

    public AccessoriesCategoriesViewHolder(View itemView, View.OnClickListener listener) {
        super(itemView);
